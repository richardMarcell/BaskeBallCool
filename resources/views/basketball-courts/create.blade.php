...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
      ...
      <form class="mt-5" action="{{ route('basketball-courts.store') }}" method="post" class="mx-auto">
        @csrf
        @if (session('success'))
        ...
        <input type="text" class="container mx-3" name="nama_lapangan" id="nama_lapangan" value="{{ old('nama_lapangan') }}">
        ...
        <input type="text" class="container mx-3" name="alamat" id="alamat" value="{{ old('alamat') }}">
        ...
        <button type="submit" class="mt-2 mx-3 btn btn-primary container">Kirim</button>
      </form>
